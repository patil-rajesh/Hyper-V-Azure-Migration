...
- [Phase 3 — Configure Internal Networking](#phase-5--configure-internal-networking)
- [Phase 4 — Build the SQL Server VM (SQL01)](#phase-3--build-the-sql-server-vm-sql01)
- [Phase 5 — Build the Web Server VM (WEB01)](#phase-4--build-the-web-server-vm-web01)
